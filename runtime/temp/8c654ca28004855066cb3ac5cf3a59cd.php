<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"/Users/hxfy/Documents/phpWorkSpace/blog/public/../application/admin/view/tip/index.html";i:1489992446;s:84:"/Users/hxfy/Documents/phpWorkSpace/blog/public/../application/admin/view/layout.html";i:1489992446;}*/ ?>
<!DOCTYPE html>
<html lang="Zh-cn">
<head>
...
<div class="row-fluid">
    <div class="widget-box span12">
        ...
        <div class="widget-title">
            <h5>Tip 管理</h5>
            <a class="label label-info add" data-height="300" data-url="<?php echo url('Admin/Tip/add'); ?>">添加</a>
            <a class="label label-info sort" data-url="<?php echo url('Admin/Tip/sort'); ?>">排序</a>
        </div>
        <div class="widget-content">
            ...
            <table class="table table-bordered table-striped with-check">
                ...
                <tbody>
                <?php if(is_array($tiplist) || $tiplist instanceof \think\Collection): $k2 = 0; $__LIST__ = $tiplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($k2 % 2 );++$k2;?>
                <tr>
                    <td><?php echo $t['tip_id']; ?></td>
                    <td><?php echo $t['tip_title']; ?></td>
                    <td style="text-align: center">
                        <button class="btn btn-mini changgeview" data-url="<?php echo url('Admin/Tip/view'); ?>" data-id="<?php echo $t['tip_id']; ?>" data-view="<?php echo $t['tip_view']; ?>"><?php echo !empty($t['tip_view'])?'显示':'不显示'; ?></button>
                    </td>
                    <td>
                        <input type="text" value="<?php echo $t['tip_sort']; ?>" name="sort[<?php echo $k2; ?>][tip_sort]">
                        <input type="hidden" value="<?php echo $t['tip_id']; ?>" name="sort[<?php echo $k2; ?>][tip_id]">
                    </td>
                    <td style="text-align: center">
                        <button type="button" class="btn btn-mini edit" data-height="300" data-url="<?php echo url('Admin/Tip/edit',['id'=>$t['tip_id']]); ?>">修改</button>
                        <button type="button" class="btn btn-mini delete" data-url="<?php echo url('Admin/Tip/delete'); ?>" data-id="<?php echo $t['tip_id']; ?>">删除</button>
                    </td>
                </tr>
